...
use git_mesh::{CopyDetection, LinkResolved, LinkStatus, MeshResolved, RangeSpec, SideSpec, StoredLink};
...
pub(crate) fn format_current_location(location: &git_mesh::LinkLocation) -> String {
    format!("{}#L{}-L{}", location.path, location.start, location.end)
}

pub(crate) fn format_side_anchored(side: &git_mesh::SideResolved) -> String {
    format_range_spec(&RangeSpec {
...
pub(crate) fn format_stored_side(side: &git_mesh::LinkSide) -> String {
    format_range_spec(&RangeSpec {
