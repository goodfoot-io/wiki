...
//! from the index and every other lookup continues to work.
//!
...
//!    insert at `index.rs:1040-1055`, taking unrelated pages offline.
...
//! returns the alias-conflict error instead of finding the requested page.
...
/// `wiki summary` returns the conflict error instead of the requested page.
