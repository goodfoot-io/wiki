...
- The [wiki handbook skill instructions](/plugins/wiki/skills/handbook/SKILL.md) are the highest-leverage agent workflow contract for discovering pages, choosing where to write, validating fragment links, and updating related pages.
